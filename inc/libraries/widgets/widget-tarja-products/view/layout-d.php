...
<div class="tarja-product-list-container">

	<div class="tarja-product-list">
		<?php while ( $posts->have_posts() ) : $posts->the_post();
			...
			<div class="tarja-product <?php echo esc_attr( ! empty( $params['color'] ) ? $params['color'] : '' ) ?>">
				<div class="row">
					<div class="col-xs-6">
						<div class="tarja-product-image">
							...
							if ( has_post_thumbnail() ) {
								$image = get_the_post_thumbnail( get_the_ID(), 'tarja-product-layout-c' );
							};
					...
					<div class="col-xs-6">
						<div class="tarja-product-body text-left">
