...
/**
 * Class Widget_tarja_Contact
 */
class Widget_tarja_Contact extends WP_Widget {
	/**
	 * @internal
	 */
	public function __construct() {
		 ...
		 */
		parent::__construct(
			'tarja_Companion_Contact',
			__( 'tarja Companion Contact Widget', 'tarja' ),
			array(
				'description'                 => esc_html__( 'tarja Companion Contact Widget', 'tarja' ),
	...
	public function widget( $args, $instance ) {
		...
		$defaults = array(
			'contact_title' => esc_html__( 'Contact', 'tarja' ),
			'address'       => esc_html__( '123 Street Name, City, England.', 'tarja' ),
			'phone'         => esc_html__( '(123) 456-7890', 'tarja' ),
			'email'         => esc_html__( 'mail@tarja.com', 'tarja' ),
		);
		...
		$args['before_widget'] = str_replace( 'class="', 'class="tarja-contact-widget ', $args['before_widget'] );
	...
	public function form( $instance ) {
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'contact_title' ) ); ?>"><?php esc_html_e( 'Contact section title:', 'tarja' ); ?></label>
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'address' ) ); ?>"><?php esc_html_e( 'Address:', 'tarja' ); ?></label>
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>"><?php esc_html_e( 'Phone number:', 'tarja' ); ?></label>
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Email:', 'tarja' ); ?></label>
