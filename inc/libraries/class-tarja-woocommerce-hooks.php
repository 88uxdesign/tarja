 ...
 * Class tarja_Hooks
 */
class tarja_WooCommerce_Hooks {
	/**
	 * tarja_WooCommerce_Hooks constructor.
	 */
	...
	public function pagination() {
		...
		echo '<div class="row text-center"><ul class="tarja-pager">' . "\n";

		/**
		 * Previous Post Link
		 */
		if ( get_previous_posts_link() ) {
			printf( '<li>%s</li>' . "\n", get_previous_posts_link( '<span class="fa fa-long-arrow-left"></span> <span class="pager-text prev">' . esc_html__( 'PREV', 'tarja' ) . '</span>' ) );
		}
		...
		if ( get_next_posts_link() ) {
			printf( '<li>%s</li>' . "\n", get_next_posts_link( '<span class="pager-text right">' . esc_html__( 'NEXT', 'tarja' ) . '</span> <span class="fa fa-long-arrow-right"></span>' ) );
		}
