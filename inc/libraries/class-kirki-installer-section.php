	...
	class Kirki_Installer_Section extends WP_Customize_Section {
		...
		protected function render() {
			...
			<div style="padding:10px 14px;">
				<?php if ( ! $installed ) : ?>
					<?php esc_attr_e( 'Kirki Toolkit plugin is required to take advantage of this theme\'s features in the customizer.', 'tarja' ); ?>
					<a class="install-now button-primary button" data-slug="kirki"
					   ...
					   data-name="Kirki Toolkit"><?php esc_html_e( 'Install Now', 'tarja' ); ?></a>
				<?php else : ?>
					<?php esc_attr_e( 'Kirki Toolkit plugin is required to take advantage of this theme\'s features in the customizer.', 'tarja' ); ?>
					<a class="install-now button-secondary button" data-slug="kirki"
					   ...
					   data-name="Kirki Toolkit"><?php esc_html_e( 'Activate Now', 'tarja' ); ?></a>
				<?php endif; ?>
			</div>
			<?php
		}
