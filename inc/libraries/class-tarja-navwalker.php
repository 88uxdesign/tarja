...
/**
 * Class tarja_Navwalker
 */
class tarja_Navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'edit_theme_options' ) ) {
			...
			echo '>';
			echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="">' . esc_html__( 'Add a menu', 'tarja' ) . '</a></li>';
			echo '</ul>';
			if ( $container ) {
				echo '</' . esc_attr( $container ) . '>';
			}
			...
			echo '>';
			echo '<li><a href="' . esc_url( get_home_url() ) . '" title="">' . esc_html__( 'Home', 'tarja' ) . '</a></li>';
			echo '</ul>';
			if ( $container ) {
				echo '</' . esc_attr( $container ) . '>';
			}
