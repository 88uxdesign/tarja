...
/**
 * Class Widget_tarja_Products
 */
class Widget_tarja_Products extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'tarja_Products',
			__( 'tarja Products', 'tarja' ),
			array(
				'description'                 => esc_html__( 'Displays your products in the frontend through different layouts!', 'tarja' ),
	...
	public function widget( $args, $instance ) {
		...
		$args['before_widget'] = str_replace( 'class="', 'class="tarja-products ' . $instance['color'] . ' ', $args['before_widget'] );

		if ( 'no' === $instance['show_title'] || '' === $instance['title'] ) {
			$args['before_widget'] = str_replace( 'class="tarja-products', 'class="tarja-products no-title', $args['before_widget'] );
		}
	...
	function form( $instance ) {
		...
		wp_localize_script( 'tarja_media_upload_js', 'WPUrls', array(
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'tarja' ); ?>
				:</label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>"/>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_title' ) ); ?>"><?php esc_html_e( 'Show Title', 'tarja' ); ?>:</label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'show_title' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_title' ) ); ?>" class="widefat" style="height: auto;">
				<option value="yes" <?php echo ( 'yes' === $instance['show_title'] ) ? 'selected' : '' ?>>
					<?php echo esc_html__( 'Yes', 'tarja' ) ?>
				</option>
				<option value="no" <?php echo ( 'no' === $instance['show_title'] ) ? 'selected' : '' ?>>
					<?php echo esc_html__( 'No', 'tarja' ) ?>
				</option>
			</select>
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'cats' ) ); ?>"><?php esc_html_e( 'Categories', 'tarja' ); ?>
				:</label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'cats' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'cats' ) ); ?>" class="widefat" style="height: auto;" size="">
				<option value="" <?php echo empty( $instance['cats'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( '&ndash; Select a category &ndash;', 'tarja' ) ?></option>
				<?php
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'color' ) ); ?>"><?php esc_html_e( 'Color', 'tarja' ); ?>
				:</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"><?php esc_html_e( 'Layout (banner position left/right/no banner/list)', 'tarja' ); ?>
				:</label>
		...
		<select name="<?php echo esc_attr( $this->get_field_name( 'layout' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>" class="widefat layout-select hidden" style="height: auto;">
			<option value="layout-a" <?php echo ( 'layout-a' === $instance['layout'] ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Products with banner on the left side', 'tarja' ) ?>
			</option>
			<option value="layout-b" <?php echo ( 'layout-b' === $instance['layout'] ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Products with banner on the right side', 'tarja' ) ?>
			</option>
			<option value="layout-c" <?php echo ( 'layout-c' === $instance['layout'] ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Products without banner', 'tarja' ) ?>
			</option>
			<option value="layout-d" <?php echo ( 'layout-d' === $instance['layout'] ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Product list', 'tarja' ) ?>
			</option>
		</select>

		</p>

		<p class="tarja-media-control" data-delegate-container="<?php echo esc_attr( $this->get_field_id( 'image' ) ) ?>">
			<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php esc_html_e( 'Banner Image', 'tarja' );
				?>:</label>
			...
			<button type="button" class="button upload-button"><?php esc_html_e( 'Choose Image', 'tarja' ); ?></button>
			<button type="button" class="button remove-button"><?php esc_html_e( 'Remove Image', 'tarja' ); ?></button>
		</p>


		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'first_line' ) ); ?>"><?php esc_html_e( 'Banner First Line', 'tarja' ); ?>
				:</label>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'second_line' ) ); ?>"><?php esc_html_e( 'Banner Second Line', 'tarja' ); ?>
				:</label>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'third_line' ) ); ?>"><?php esc_html_e( 'Banner Third Line', 'tarja' ); ?>
				:</label>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'Banner Button Link', 'tarja' ); ?>
				:</label>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'Banner Button Label', 'tarja' ); ?>
				:</label>
