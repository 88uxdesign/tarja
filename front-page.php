	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<header>
					<?php
					$blog_name = get_option( 'blogname', 'tarja' );
				...
				<main id="main" class="site-main" role="main">
					...
					if ( have_posts() ) :
						...
						the_posts_pagination(
							array(
								'prev_text' => '<span class="pagination-arrow-container"><span class="fa fa-long-arrow-left"></span> ' . esc_html__( 'PREV', 'tarja' ) . '</span>',
								'next_text' => '<span class="pagination-arrow-container">' . esc_html__( 'NEXT', 'tarja' ) . ' <span class="fa fa-long-arrow-right"></span></span>',
							)
						);
